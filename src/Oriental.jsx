...
<center><h1 className='carouselh'>قسم الشرقي</h1></center>
...
<div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="\images\عش البلبل.jpg" className="carousel-imgg" alt="..." />
    </div>
    <div className="carousel-item">
      <img src="\images\كنافه مكسرات.jpg" className="carousel-imgg" alt="..." />
    </div>
    <div className="carousel-item">
      <img src="\images\شرقي.jpg" className="carousel-imgg" alt="..." />
    </div>
  </div>
...
<div id="carouselExampleIndicators2" className="carousel slide" data-bs-ride="carousel">
  ...
  <div className=" carousel-b carousel-inner">
    <div className="carousel-item active">
      <img src="\images\جلاش صوابع.jpg" className=" carousel-img" alt="..." />
    </div>
    <div className="carousel-item">
      <img src="\images\رموش.jpg" className="carousel-img " alt="..." />
    </div>
    <div className="carousel-item">
      <img src="\images\جلاش فسدق.jpeg" className="carousel-img " alt="..." />
    </div>
  </div>
